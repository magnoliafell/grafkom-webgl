...
async function main() {
  ...
  const objHref = '/object/nintendo.obj';  
  ...
  function render(time) {
    ...
    // Apply scaling: [scaleX, scaleY, scaleZ]
    const scale = [4, 4, 4];  // Scale the object by 2x on all axes (you can change these values)
    u_world = m4.scale(u_world, ...scale); // Apply scaling to the world matrix
